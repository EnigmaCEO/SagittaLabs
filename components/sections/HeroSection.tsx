...
export function HeroSection() {
  return (
    <section className="relative mx-auto max-w-6xl px-4 pb-10 pt-8 sm:px-6 lg:px-8 lg:pb-14 lg:pt-12">
      ...
      <div className="relative z-10 overflow-hidden rounded-[30px] border border-transparent bg-[radial-gradient(circle_at_84%_16%,rgba(88,104,255,0.28),transparent_34%),linear-gradient(180deg,rgba(9,22,49,0.82),rgba(5,10,24,0.9))] px-5 py-11 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_24px_70px_rgba(1,4,13,0.5)] sm:px-10 sm:py-14 lg:px-14">
        ...
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 font-[var(--font-body)] text-[2.55rem] font-medium leading-[0.98] tracking-[-0.025em] text-[#bcc6d3] max-[390px]:text-[2.2rem] sm:text-6xl lg:text-7xl">
            Resilient capital infrastructure for systems that cannot fail
          </h1>
          <p className="mt-6 max-w-xl text-base leading-relaxed text-[#6f86a7] sm:text-[1.08rem]">
          ...
          <div className="mt-6 grid gap-2.5 sm:mt-7 sm:grid-cols-3 sm:gap-3">
            <div className="nexus-subitem rounded-xl px-3 py-2 max-[390px]:px-2.5">
